...
function jFLocalOrderDetails(value, row, index) {
    if (row.IsItems) {
        ...
        return [
            `<a href="/Laundry/Branch/NewOrders/HtmlFiles/AddItemsWBtns.html?OrderNumber=${row.pk}" data-ordernumber="${row.pk}" class="btn btn-outline-success SettlementButtonClass" >`,
